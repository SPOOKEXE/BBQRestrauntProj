...
function Module:GetAnimatorFromInstance(Parent)
	...
	if HumanoidOrController then
		return HumanoidOrController:FindFirstChildWhichIsA('Animator')
	end
	return false
end
...
if not RunService:IsServer() then
	...
	function Module:LoadAnimationToLocal(Animation, doNotLoadIfNull)
		Module:LoadAnimationToCharacter(LocalPlayer.Character, Animation, doNotLoadIfNull)
	end
